const ExpressPay = async config => (async config => {
     ...
     * @throws Error
     */
    const updateExpressPayOrder = async gatewayId => {
    ...
    const updateMagentoAddress = async (addressType, addressData) => {
        ...
        try {
            ...
            console.error(
                `Could not process response from updating Magento ${addressType} address for Express Pay order.`,
                error
            );
    ...
    const updateMagentoShippingMethod = async shippingOptions => {
        ...
        try {
            ...
            console.error(
                `Could not process response from updating Magento shipping method for Express Pay order.`,
                error
            );
        ...
        sdkConfiguration = {
            ...
            callbacks: {
                ...
                onUpdatePaymentOrder: async (paymentType, paymentPayload) => {
                    ...
                    await updateExpressPayOrder(paymentPayload.gateway_id)
                },
                /**
                 * @param {String} paymentType
